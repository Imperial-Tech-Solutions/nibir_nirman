...
const Contact= () => {
  ...
  return (
    ...
    <div class="container px-6 py-12 mx-auto">
        <div>
            <p class="font-medium text-[#60AD02]">Contact us</p>
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                    <span class="inline-block p-3 text-white rounded-full bg-[#60AD02]">
                    ...
                    <p class="mt-2 text-sm text-[#60AD02] ">hello@merakiui.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-[#60AD02] ">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-[#60AD02] ">+1 (555) 000-0000</p>
                </div>
            </div>
  ...
  width="600"
  height="450"
  style={{ border: 0 }} // Use React's object syntax for styles
  allowFullScreen
  loading="lazy"
